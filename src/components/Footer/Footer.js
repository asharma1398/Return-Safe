...
export default function Footer(props) {
    return (
        <footer className="row hide-on-large-only">
            <button className="btn-large col s6 red darken-4" id="calenderBtn" onClick={props.displayCalender}><span className="left navText">Calender</span><i className="small material-icons">date_range</i></button>
